...
(function () {
  ...
  // ---- Modulreihenfolge (Landing nicht mitgezaehlt) ----
  var MODULES = [
    ...
    { id: "observability", file: "05-observability.html", num: 5,  short: "Observability" },
    { id: "bauen",         file: "06-bauen.html",         num: 6,  short: "Agenten bauen: Vorgehen & Frameworks" },
    { id: "handson",       file: "07-handson.html",       num: 7,  short: "Hands-On Lab" },
    { id: "fallstricke",   file: "08-fallstricke.html",   num: 8,  short: "Fallstricke" },
    { id: "security",      file: "09-security.html",      num: 9,  short: "Security" },
    { id: "abschluss",     file: "10-abschluss.html",     num: 10, short: "Abschluss & Ressourcen" }
  ];
  var LANDING = "index.html";
  var PKEY = "cbt_agentic_progress_v1";
  var TKEY = "cbt_agentic_theme";

  // ---- Storage helpers (robust gegen Privacy-Mode) ----
  ...
  // ---- aktuelles Modul aus <body data-mod> ----
  ...
  function buildChrome() {
    ...
    // Logo-Fallback auf offizielle URL, falls lokale Datei fehlt
    ...
    // Pager (prev/next) - nur auf Modulseiten, Slot #pager
